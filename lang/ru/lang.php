...
return [
    ...
    'components' => [
        ...
        'session' => [
            'name' => 'Сессия ползователя',
            'description' => 'Управляет сессией пользователя, ставит ограничения доступа или перенаправляет на другую страницу',
            'redirect' => [
                'title' => 'перенаправление',
                'description' => 'Параметр перенаправления, указывается для того что бы перенаправить пользователя на другую страницу. признаками перенаправления могут быть: просроченный токен, разрешенные группы и т.п.',
            ],
        ],
    ],
    'settings' => [
